...
<main class="form-signin w-100 m-auto">
  ...
  <form action="listar.php" method="get" accept-charsete="utf-8">
    ...
    <div class="form-floating">
      <input type="enumber" class="form-control" name="quantidade" >
      <label for="floatingInput">Quantidade</label>
    </div>

    <input class="w-100 btn btn-lg btn-primary" type="submit" name="enviar">
    <a class="link__produtos" href="lista.php">Lista de produtos</a>
  </form>
</main>
